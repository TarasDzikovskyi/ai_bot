        ...
        try {
            if (msg.text === '/start') {
                if (!db_user) {
                    ...
                    return bot.sendMessage(chatId, 'Привіт, я AI сейлз🤖 Boxline Ukraine. Буду радий надати найкращу ціну згідно Вашого запиту😃. ' +
                        'Надішліть текст📝 або аудіо🎤 повідомлення у довільній формі з параметрами вантажу для прорахунку🚢. ' +
                        'Вкажіть обов`язково звідки відправка⚓️ і куди доставка🚚 вага об`єм, тариф дається завжди на умовах фоб.', {
                        reply_markup: {
                            keyboard: [
